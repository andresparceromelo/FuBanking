...
export const metadata = {
  title: 'Notificaciones | FuBanking',
  description: 'Revisa todas tus alertas y notificaciones de FuBanking.',
};
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Alertas y avisos sobre tu actividad bancaria.</p>
      </div>
