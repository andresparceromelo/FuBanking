/**
 * Validación robusta de correos electrónicos (capa de backend).
 *
 ...
 *
 * Nota: Esta validación es una capa de seguridad adicional sobre la validación
 * de formato básico (.email() de Zod). No reemplaza una verificación de existencia.
 */
